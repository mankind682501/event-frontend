  ...
  return (
    ...
    <div style={{backgroundColor:'black'}}>
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center mt-5">
                <div className=''>
                    <h1 className='text-center'style={{fontSize:'130px'}}>IT'S A DATE</h1>
                    <h1 className='text-center mt-3 fs-1'>SPARK SOMETHING NEW</h1>

                </div>
            </div>
            <div id='d12' className="col-md-6 mt-5">
                ...
                <div className="row">
                               {isToken ? 
                                   ...
                                   {musicEvents.length > 0 ? (
                                     musicEvents .filter((event) => event.eventType === 'Dating').map((event) => (
                                   ...
                                   <div className="row">
                                              ...
                                              <div className="col-md-6">
                                                ...
                                                <div className='text-center px-5'> 
                                                  <Link to={'/'}> <button className='btn btn-light mb-3'>Go Back</button></Link>
                                                </div>
                                              </div>
