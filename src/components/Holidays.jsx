    ...
    <>
      <div style={{backgroundColor:'black'}}>
       ...
       <div className="col-md-6 d-flex justify-content-center align-items-center mt-5">
           <div className=''>
               <h1 className='text-center'style={{fontSize:'130px'}}>HOLIDAY EVENTS</h1>
               <h1 className='text-center mt-3 fs-1'>DISCOVER BEST HOLIDAY EVENTS IN YOUR AREA</h1>

           </div>
       </div>
       <div id='h12345' className="col-md-6 mt-5">
           ...
           <div className="row">
                {isToken ? 
                    ...
                    {musicEvents.length > 0 ? (
                      musicEvents .filter((event) => event.eventType === 'Holidays').map((event) => (
